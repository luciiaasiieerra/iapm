...
#pasos ->
    #hacer el json que dice zafra
    #modificar el codigo para el json (que se meta por consola .json)
    #hacer los 3 tipos de preguntas
    #suffle de el tipo (que solo saque una)
    #pasar a javascript o php
    #meter la opcion de ollama o de open ai